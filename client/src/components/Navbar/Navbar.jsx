        ...
        <>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button
                href="#"
                className="mx-1 whitespace-nowrap inline-flex items-center justify-center px-2 py-2 border bg-blue-700 border-transparent rounded-md shadow-sm text-sm text-white font-sm hover:bg-pink-500"
              >
                Dist Login
              </button>
              <button
