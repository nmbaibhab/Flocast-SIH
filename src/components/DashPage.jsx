            ...
            <div className="border-2 border-gray-400 border-dashed hover:border-transparent hover:bg-white hover:shadow-xl rounded p-6 m-2 md:mx-10 md:my-6">
              <div className="flex flex-col items-center">
                ...
                <div className="flex-1">
                  ...
                  <h5 className="font-bold text-gray-500">Total Rescue Campaign Around You</h5>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="p-5">
                  <div className="p-3">
                    ...
                    <div className="p-5">
                      <table className="w-full p-5 text-gray-700">
                        <thead>
                          <tr>
                            ...
                            <th className="text-left text-blue-900">Location</th>
                            <th className="text-left text-blue-900">Phone</th>
                          </tr>
                        </thead>

                        <tbody>
                          <tr>
                            <td>Dhrubajyoti Chakraborty</td>
                      ...
                      <p className="py-2">
                        <a href="#">See more people in your region...</a>
                      </p>
                    </div>
                  </div>
                </div>
